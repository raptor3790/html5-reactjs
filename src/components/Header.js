        ...
        <header id="header" className="full-header">
            ...
            <div id="header-wrap">
                ...
                <div className="container clearfix">
                    ...
                    <div id="logo">
                        <a href="/" className="standard-logo"><img src="images/logo.png" alt="Logo" /></a>
                    </div>
                            ...
                            <li className="mega-menu"><a href="/"><div>Shortcodes</div></a>
                                <div className="mega-menu-content clearfix">
                                    <ul className="mega-menu-column col-5">
                                        ...
                                        <li><a href="component-datatable.html"><div><i className="icon-table"></i>Data Tables</div></a></li>
                                        <li><a href="component-datepicker.html"><div><i className="icon-calendar3"></i>Date &amp; Time Pickers</div></a></li>
                                    </ul>
                                    <ul className="mega-menu-column col-5">
                                        ...
                                        <li><a href="form-elements.html"><div><i className="icon-edit"></i>Form Elements</div></a></li>
                                        <li><a href="component-uploads.html"><div><i className="icon-line-upload"></i>File Uploads</div></a></li>
                                    </ul>
                                    <ul className="mega-menu-column col-5">
                                        <li><a href="lists-cards.html"><div><i className="icon-th-list"></i>Lists &amp; Cards</div></a></li>
                                        ...
                                        <li><a href="component-range-slider.html"><div><i className="icon-line-move"></i>Range Slider</div></a></li>
                                        <li><a href="component-ratings.html"><div><i className="icon-star3"></i>Star Ratings</div></a></li>
                                    </ul>
                                    <ul className="mega-menu-column col-5">
                                        ...
                                        <li><a href="component-select-picker.html"><div><i className="icon-select"></i>Select Picker</div></a></li>
                                        <li><a href="component-select-box.html"><div><i className="icon-line-columns"></i>Select Boxes</div></a></li>
                                    </ul>
                                    <ul className="mega-menu-column col-5">
                                        ...
                                        <li><a href="component-radios-switches.html"><div><i className="icon-line-square-check"></i>Radios &amp; Switches</div></a></li>
                                        <li><a href="flip-cards.html"><div><i className="icon-refresh"></i>Flip Cards</div></a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
